...
sudo mount -t cifs //mslandcoverstorageeast.file.core.windows.net/chesapeake /mnt/afs/chesapeake -o vers=3.0,username=mslandcoverstorageeast,password=hZd2xSYmEIWvLLbQ/B5HyhML3kkO1cnxXvxTcwNA6pf0yAJH9K5HHVTyRgcnJLteUOo7r6wTb2NNvEPiihLXYA==,dir_mode=0777,file_mode=0777,serverino
sudo mount -t cifs //msrcalebubuntu.file.core.windows.net/code               /mnt/afs/code       -o vers=3.0,username=msrcalebubuntu,password=t95USRae3gtcHvAPND6Am5Uvkrl7nxMeQIjxG0zSqgQ3DQT0G6EsYuOTlEFfniVd6z2QEDjN6dmalMLGn8kbeQ==,dir_mode=0777,file_mode=0777,serverino
